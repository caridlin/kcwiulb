...
- [Step 4b: Blue Sky Subtraction (Iter 1)](docs/step4b1_sky_blue_iter1.md)  
- [Step 4b: Blue Sky Subtraction (Iter 2)](docs/step4b2_sky_blue_iter2.md)

- [Step 4r: Red Sky Subtraction](docs/step4r_sky_red.md)

- **Step 5: Coadd**
  - [Blue](docs/step5_coadd_blue.md)
  - [Red](docs/step5_coadd_red.md)  
