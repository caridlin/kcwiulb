...
PA = 125
ALPHA = 3.0  # sigma threshold for cosmic ray detection (higher = more conservative, fewer pixels flagged)
PX_THRESH = 0.1
...
# ------------------------------------------------------------
INPUT_SUFFIX = "_icubes.wc.c.sky.fits"
...
def main():
    ...
    print("Running red cosmic-ray masking")
    print(f"  PA: {PA}")
    print(f"  ALPHA: {ALPHA}")
    ...
    for i, group_name in enumerate(group_names, start=1):
        ...
        try:
            result = cosmic_ray_mask_red_group(
